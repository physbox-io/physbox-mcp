...
#: Total tools the server exposes — "222 Native MCP Tools" on every page.
SITE_TOTAL = 222

#: The breakdown in the sentence under "222 Tools. One pip install."
SITE_SIMULATOR = 208  # etch, circuit, physics and process, less the two below
