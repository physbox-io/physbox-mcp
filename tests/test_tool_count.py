...
#: Total tools the server exposes — "223 Native MCP Tools" on every page.
SITE_TOTAL = 223

#: The breakdown in the sentence under "223 Tools. One pip install."
SITE_SIMULATOR = 209  # etch, circuit, physics and process, less the two below
