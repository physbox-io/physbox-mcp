...
#: Total tools the server exposes — "220 Native MCP Tools" on every page.
SITE_TOTAL = 220

#: The breakdown in the sentence under "220 Tools. One pip install."
SITE_SIMULATOR = 206  # etch, circuit, physics and process, less the two below
